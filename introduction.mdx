...
<CardGroup cols={2}>
  ...
  <Card title="Backtest AI Agent BETA" icon="sparkles" href="/api-reference/backtest-ai-agent">
    Generate a replay-ready strategy from plain English. Pro includes the beta free with 5 strategy generations per month.
  </Card>
