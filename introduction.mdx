...
<CardGroup cols={2}>
  ...
  <Card title="Binance Spot" icon="coins" href="/api-reference/binance-spot">
    Access BTC, ETH, and SOL spot prices, depth, trades, and BTC/USDT historical snapshots.
  </Card>
  <Card title="Binance Futures" icon="chart-candlestick" href="/api-reference/binance-futures">
    Access BTC, ETH, and SOL futures prices, depth, trades, and BTC/USDT historical snapshots.
  </Card>
</CardGroup>
...
| BTC, ETH, SOL | Binance Spot & Futures live data | Pro & Enterprise |
